		...
		$srcImg.one('load', function() {
			...
			var finishGame = function() {
				if(success.fadeOriginal) {
					...
					if(control.toggleNumbers) $numbersButton.addClass('jqp-disabled');
					alert('BERHASIL!!!');
					$("#sukses").append('<div class="alert alert-success fade show"> <span class="close" data-dismiss="alert">×</span>  <strong>Berhasil!</strong>   <a href="3.html" class="btn btn-info btn-sm">Gambar Selanjutnya ?</a>. </div>' +
					'<ul>' +
					'<li> Nama latin	:	Aceros cassidix Temminck, 1823</li>' +
					'<li> Nama Inggris	:	Knobbed Hombil</li>' +
					'<li> Nama Lokal	:	Allo, Luppi</li>' +
					'<li> Status Konservasi	:	IUCN : Konsentrasi rendah/ Least concern(versi 3.1), CITES : Appendix II, PP  no.7 th 1999 : Dilindungi pemerintah RI</li>' +
					'<li> Panjang tubuh dapat mencapai 100 cm pada jantan, dan 88 cm pada betina. Julang Sulawesi memiliki tanduk (casque) yang besar di atas paruh, berwarna merah pada jantan dan kuning pada betina. Paruh berwarna kuning dan memiliki kantung biru pada tenggorokan</li>' +
					'<li> Biasa terbang rendah diatas kanopi hutan secara berkelompok </li>' +
					'<li> Makanan utama julang sulawesi adalah buah-buahan dan sesekali binatang-binatang kecil sperti kadal, kelelawar, tikus, ular dan berbagai jenis serangga</li>' +
					'<li> Julang sulawesi sangat menyukai buah beringin (Ficus SP)</li>' +
