		...
		$srcImg.one('load', function() {
			...
			var finishGame = function() {
				if(success.fadeOriginal) {
					...
					if(control.toggleNumbers) $numbersButton.addClass('jqp-disabled');
					alert('BERHASIL!!!');
					$("#sukses").append('<div class="alert alert-success fade show"> <span class="close" data-dismiss="alert">×</span>  <strong>Berhasil!</strong>   <a href="2.html" class="btn btn-info btn-sm">Gambar Selanjutnya ?</a>. </div>' +
					'<ul>' +
					'<li> Nama latin	:	Macaca Nigra Desmarest, 1822</li>' +
					'<li> Nama Inggris	:	Celebes Black Macaque</li>' +
					'<li> Nama Lokal	:	Yaki(Tonsea, Bacan), Wolai(Tondano), Bolai(mangondow)</li>' +
					'<li> Status Konservasi	:	IUCN : Genting/ Endangered(versi 3.1), CITES : Appendix II, PP  no.7 th 1999 : Dilindungi pemerintah RI</li>' +
					'<li> Ukuran panjang tubuh sekitar 445-600. panjang ekor jantan 20 mm</li>' +
					'<li> Berat berkisar antara 7-15 Kg. </li>' +
					'<li> bagian anggota badan didominasi warna hitam kelam namun bagian punggung dan paha lebih terang. </li>' +
					'<li> wajahnya juga berwarna hitam tidak ditumbuhi rambut dan kepala memiliki jambul </li>' +
					'<li> bantalan kawin berbentuk ginjal berwarna kuning</li>' +
					'<li> moncong lebih menonjol dari monyet sulawesi lainnya</li>' +
