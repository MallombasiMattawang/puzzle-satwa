		...
		$srcImg.one('load', function() {
			...
			var finishGame = function() {
				if(success.fadeOriginal) {
					...
					if(control.toggleNumbers) $numbersButton.addClass('jqp-disabled');
					alert('BERHASIL!!!');
					$("#sukses").append('<div class="alert alert-success fade show"> <span class="close" data-dismiss="alert">×</span>  <strong>Berhasil!</strong>   <a href="4.html" class="btn btn-info btn-sm">Gambar Selanjutnya ?</a>. </div>' +
					'<ul>' +
					'<li> Nama latin	:	Babulus depressicornis H. Smith, 1827</li>' +
					'<li> Nama Inggris	:	Lowland Anoa</li>' +
					'<li> Nama Lokal	:	Kadue meeto(Tolaki-sulawesi tenggara)</li>' +
					'<li> Status Konservasi	:	IUCN : Genting / Endangered(versi 3.1), CITES : Appendix I, PP  no.7 th 1999 : Dilindungi pemerintah RI</li>' +
					'<li> Bentuk tubuh dan kepala menyerupai kerbau tetapi lebih kecil, tanduk memanjang lurus kebelakang.</li>' +
					'<li> Warna Rambut dari hitam kecoklatan sampai hitam legam, rambut lebih jarang pada individu dewasa. </li>' +
					'<li> Telinga berbentuk Oval(lonjong) dengan ujung meruncing. bagian dalam berwarna terang(putih kecoklatan) ada noktah putih di daun telinga sebelah dalam</li>' +
					'<li> kadang terdapat warna putih pada bagian bawah leher berbentuk bulan sabit (white crescent)</li>' +
					'<li> panjang tanduk dapat mencapai 35cm </li>' +
					'<li> Anoa termasuk satwa ruminansa browser (lebih banyak memakan dedaunan dari pada rerumputan)</li>' +
					'<li> Jenis makanan terutama tumbuhan dikotil (70%) yaitu daun lebar serta berbagai jenis tumbuhan bawah dan liana, dan tumbuhan monokotil seperti jenis rumput, bamboo dan berbagai jenis buah yang jatuh ke lantai hutan seperti buah kayu hitam (Diospyro malabarica), berbagai jenis beringin(Ficus spp), dongi (Dillenia ochreata), rao (Dracontonomelon mangiferum), matoa(Pometia pinnata)</li>' +
					'<li>anoa dataran rendah menghuni hutan dataran rendah pada ketinggian 0-1000 m dpl, sedangkan anoa gunung lebih sering dijumpai pada ketinggian lebih dari 1000 m dpl. Namun pembagian ketinggian tempat tidaklah mutlak. karena sering juga dijumpai anoa gunung di habitat dibawah 1000 m dpl, bahkan sering dijumpai di hutan pantai mencari mineral </li>' +
					'<li> </li>' +
